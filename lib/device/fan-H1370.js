...
/*
  ...
  Status aa 31 [running] [speed] = fan speed (1 to the model's step count)
  ...
  externalUpdate(params) {
    ...
    (params.commands || []).forEach((command) => {
      ...
      switch (deviceFunction) {
        // aa 31 <running> <speed>. The third byte is the fan's running flag,
        // not part of the code - a stopped fan reports 3100 and still names the
        // speed it will return to. Reading only 3101 meant that every status
        // sent while the fan was off was announced as unrecognised, which is
        // the noise that sent this model's owner to the issue tracker (#1352)
        case '3100':
        case '3101': {
          // Fan speed
