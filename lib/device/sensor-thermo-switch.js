...
export default class extends GoveeDevice {
  constructor(platform, accessory) {
    ...
    // The whole point of this handler is to lead with the temperature. Without
    // saying which service leads, the Home app picks one of the three for the
    // tile and lands on humidity - so an owner sees a percentage and has to
    // open the accessory to find the temperature they turned this on for.
    // The plain thermo handler next door has always said so; this one never
    // did (#1354)
    this.thermoService.setPrimaryService(true)
